...
/**
 * Handler for {@link FinalNode}.
 */
public class FinalNodeHandler extends AbstractFlowNodeHandler {
    ...
    public NodeHandleResult handleNode(FlowNode node) {
        ...
        Token outToken = finalNode.getOutgoingToken();
        return new NodeHandleResult(null, outToken);
    }

    @Override
    public void callAfterHandled(FlowNode node, NodeHandleResult result) {
        lifecycleManageService.notifyFlowEnded(node.getFlowId());
    }
}
